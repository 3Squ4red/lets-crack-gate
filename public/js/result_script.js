...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (!resultData.fromHistory && !window._examSaved) {
        // Set flags SYNCHRONOUSLY to prevent concurrent strict mode saves
        window._examSaved = true;
        resultData.fromHistory = true;
        sessionStorage.setItem('gateExamResults', JSON.stringify(resultData));
...
function renderStrategyMetrics(summary, details) {
    ...
    section.innerHTML = `
        ...
        <div class="metrics-grid">
            ...
            <div class="metric-card">
                <div class="metric-label">Score Efficiency</div>
        ...
        btn.addEventListener('click', async function (e) {
            ...
            try {
                if (isCurrentlyBookmarked) {
                    ...
                    const questionData = details.find(dd => String(dd.questionId) === String(qid));
                    if (questionData) {
