  ...
  "sections": [
    {
      ...
      "questions": [
        {
          "id": 1,
          "question": "<p><a name=\"336309\"></a><div itemprop=\"text\"><p>In a cache memory if total number of sets are ‘\\( s \\)’, then the set offset is:</p></div><br><br><b>NIELIT 2017 DEC Scientist B - Section B: 4</b></p>",
          "type": "single",
          "options": [
            "<p>\\( 2^8 \\)</p>",
            "<p>\\( \\log_2s \\)</p>",
        ...
        {
          "id": 5,
          "question": "<p><a name=\"351613\"></a><div itemprop=\"text\"><p>A direct mapped cache is of size \\( \\text{32 KB} \\) and has block size \\( 32 \\) Bytes. CPU also generates \\( 32 \\) bit address. Number of bits needed for indexing the cache:</p></div><br><br><b>NIELIT Scientist B 2020 November: 69</b></p>",
          "type": "single",
          "options": [
            "<p>\\( 14 \\)</p>",
            "<p>\\( 15 \\)</p>",
