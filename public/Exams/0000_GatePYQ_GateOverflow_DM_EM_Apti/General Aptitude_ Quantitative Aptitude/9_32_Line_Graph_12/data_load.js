window.__examLoadCallback({
  "title": "General Aptitude_ Quantitative Aptitude - Line Graph",
  "duration": 33,
  "sections": [
    {
      "name": "Line Graph",
      "questions": [
        ...
        {
          "id": 2,
          "question": "<p><a name=\"2033\"></a><div itemprop=\"text\"><p>The ratio of male to female students in a college for five years is plotted in the following line graph. If the number of female students in \\( 2011 \\) and \\( 2012 \\) is equal, what is the ratio of male students in \\( 2012 \\) to male students in \\( 2011 \\)?</p><p style=\"text-align:center\"><img alt=\"\" height=\"242\" width=\"390\" src=\"images/gateOverFlowPDFsImages/volume1/general_aptitude_quantitative_aptitude_line_graph/c7f04b5a279e44f8d610ca1763e775f9.png\"></p></div><br><br><b>GATE CSE 2014 Set 3 | Question: GA-9</b></p>",
          "type": "single",
          "options": [
            "<p>\\( 1:1 \\)</p>",
            "<p>\\( 2:1 \\)</p>",
        ...
        {
          "id": 3,
          "question": "<p><a name=\"39535\"></a><div itemprop=\"text\"><p style=\"text-align:center\"><img alt=\"\" height=\"251\" width=\"393\" src=\"images/gateOverFlowPDFsImages/volume1/general_aptitude_quantitative_aptitude_line_graph/fa7457884d6ee4de0858fb80d8b6c994.png\"></p></div><br><br><b>GATE CSE 2016 Set 2 | Question: GA-10</b></p>",
          "type": "single",
          "options": [
            "<p>\\( f(x) = 1 - |x - 1| \\)</p>",
            "<p>\\( f(x) =1 + |x - 1| \\)</p>",
        ...
        {
          "id": 5,
          "question": "<p><a name=\"312131\"></a><div itemprop=\"text\"><p>The fuel consumed by a motorcycle during a journey while traveling at various speeds is indicated in the graph below.</p><p style=\"text-align:center\"><img alt=\"\" height=\"313\" width=\"351\" src=\"images/gateOverFlowPDFsImages/volume1/general_aptitude_quantitative_aptitude_line_graph/48308670532eda4da02db9936561c686.png\"></p><p>The distances covered during four laps of the journey are listed in the table below</p><p>\\[ \\small \\begin{array}{|c|c|}\\hline \\textbf{Lap}&nbsp; &&nbsp; \\textbf{Distance} & \\textbf{Average Speed}\\\\ & \\textbf{(kilometres)} & \\textbf{(kilometres per hour)} \\\\\\hline \\textbf{P} & 15 & 15 \\\\\\hline \\textbf{Q} & 75 & 45 \\\\\\hline \\textbf{R} & 40 & 75 \\\\ \\hline \\textbf{S} & 10 & 10 \\\\ \\hline&nbsp; \\end{array} \\]</p><p>From the given data, we can conclude that the fuel consumed per kilometre was least during the lap</p></div><br><br><b>GATE2011 AG: GA-9</b></p>",
          "type": "single",
          "options": [
            "<p>\\( P \\)</p>",
            "<p>\\( Q \\)</p>",
        ...
        {
          "id": 7,
          "question": "<p><a name=\"110905\"></a><div itemprop=\"text\"><p>Two finance companies, \\( P \\) and \\( Q \\), declared fixed annual rates of interest on the amounts invested with them. The rates of interest offered by these companies may differ from year to year. Year-wise annual rates of interest offered by these companies are shown by the line graph provided below.</p><p style=\"text-align:center\"><img alt=\"\" src=\"images/gateOverFlowPDFsImages/volume1/general_aptitude_quantitative_aptitude_line_graph/455b3d0ac3fdba145e2005c245138cf2.png\"></p><p>If the amounts invested in the companies, \\( P \\) and \\( Q \\), in \\( 2006 \\) are in the ratio \\( 8:9 \\), then the amounts received after one year as interests from companies \\( P \\) and \\( Q \\) would be in the ratio:</p></div><br><br><b>GATE2016 CE-2: GA-6</b></p>",
          "type": "single",
          "options": [
            "<p>\\( 2:3 \\)</p>",
            "<p>\\( 3:4 \\)</p>",
        ...
        {
          "id": 9,
          "question": "<p><a name=\"313674\"></a><div itemprop=\"text\"><p>In the graph below, the concentration of a particular pollutant in a lake is plotted over (alternate) days of a month in winter (average temperature \\( 10^{\\circ} C \\)) and a month in summer (average temperature \\( 30^{\\circ} C \\)).</p><p style=\"text-align:center\"><img alt=\"\" height=\"328\" width=\"522\" src=\"images/gateOverFlowPDFsImages/volume1/general_aptitude_quantitative_aptitude_line_graph/02cda45a5a0d231bd4dbf92bcf92ec3a.png\"></p><p>Consider the following statements based on the data shown above:</p><ol start=\"1\" style=\"list-style-type:lower-roman\"><li>Over the given months, the difference between the maximum and the minimum pollutant concentrations is the same in both winter and summer</li><li>There are at least four days in the summer month such that the pollutant concentrations on those days are within \\( 1 \\) ppm of the pollutant concentrations on the corresponding days in the winter month.</li></ol><p>Which one of the following options is correct?</p></div><br><br><b>GATE2017 ME-2: GA-10</b></p>",
          "type": "single",
          "options": [
            "<p>Only i</p>",
            "<p>Only ii</p>",
        ...
        {
          "id": 10,
          "question": "<p><a name=\"313251\"></a><div itemprop=\"text\"><p>Which of the following function(s) is an accurate description of the graph for the range(s) indicated?</p><p><img alt=\"\" height=\"311\" width=\"328\" src=\"images/gateOverFlowPDFsImages/volume1/general_aptitude_quantitative_aptitude_line_graph/017b727754856c6bca5b7f9b5fe7ac6b.png\"></p><ol style=\"list-style-type:lower-roman\"><li>\\( y=2x+4 \\text{for} -3 \\leq x \\leq -1 \\)</li><li>\\( y= \\mid x-1 \\mid \\text{for} -1 \\leq x \\leq 2 \\)</li><li>\\( y= \\mid\\mid x \\mid -1 \\mid \\text{for} -1 \\leq x \\leq 2 \\)</li><li>\\( y=1 \\text{for} 2 \\leq x \\leq 3 \\)</li></ol></div><br><br><b>GATE2018 CE-1: GA-8</b></p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 11,
          "question": "<p><a name=\"313386\"></a><div itemprop=\"text\"><p>The annual average rainfall in a tropical city is \\( 1000 \\) mm. On a particular rainy day (\\( 24 \\)-hour period), the cumulative rainfall experienced by the city is shown in the graph. Over the \\( 24 \\)-hour period, \\( 50 \\)% of the rainfall falling on a rooftop, which had an obstruction-free area of \\( 50 \\) \\( m^2 \\), was harvested into a tank. What is the total volume of water collected in the tank liters?</p><p style=\"text-align:center\"><img alt=\"\" src=\"images/gateOverFlowPDFsImages/volume1/general_aptitude_quantitative_aptitude_line_graph/b55d77f1ab2ffdbd20caaa3961aad303.png\"></p></div><br><br><b>GATE2018 CE-2: GA-8</b></p>",
          "type": "single",
          "options": [
            "<p>\\( 25,000 \\)</p>",
            "<p>\\( 18, 750 \\)</p>",
        ...
        {
          "id": 12,
          "question": "<p><a name=\"205091\"></a><div itemprop=\"text\"><p>In a detailed study of annual crow births in India, it was found that there was relatively no growth during the period \\( 2002 \\) to \\( 2004 \\) and a sudden spike from \\( 2004 \\) to \\( 2005 \\). In another unrelated study, it was found that the revenue from cracker sales in India which remained fairly flat from \\( 2002 \\) to \\( 2004 \\), saw a sudden spike in \\( 2005 \\) before declining again in \\( 2006 \\). The solid line in the graph below refers to annual sale of crackers and the dashed line refers to the annual crow births in India. Choose the most appropriate inference from the above data.</p><p style=\"text-align:center\"><img alt=\"\" src=\"images/gateOverFlowPDFsImages/volume1/general_aptitude_quantitative_aptitude_line_graph/5e04a99ba2ad9c3ec6cc94990c380178.png\"></p></div><br><br><b>GATE2018 CH: GA-10</b></p>",
          "type": "single",
          "options": [
