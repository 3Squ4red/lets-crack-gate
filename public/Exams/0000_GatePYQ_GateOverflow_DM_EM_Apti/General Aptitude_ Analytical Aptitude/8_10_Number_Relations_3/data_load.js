window.__examLoadCallback({
  "title": "General Aptitude_ Analytical Aptitude - Number Relations",
  "duration": 8,
  "sections": [
    {
      ...
      "questions": [
        {
          "id": 1,
          "question": "<p><a name=\"422897\"></a><div itemprop=\"text\"><p>In the \\( 4 \\times 4 \\) array shown below, each cell of the first three rows has either a cross \\( (X) \\) or a number.</p><p><img alt=\"\" width=\"300\" src=\"images/gateOverFlowPDFsImages/volume1/general_aptitude_analytical_aptitude_number_relations/11d0602c810f48cdbe683bad4c505137.png\"><br>The number in a cell represents the count of the immediate neighboring cells (left, right, top, bottom, diagonals) NOT having a cross ( \\( X \\) ). Given that the last row has no crosses \\( (X) \\), the sum of the four numbers to be filled in the last row is</p></div><br><br><b>GATE CSE 2024 | Set 2 | GA Question: 10</b></p>",
          "type": "single",
          "options": [
            "<p>\\( 11 \\)</p>",
            "<p>\\( 10 \\)</p>",
        ...
        {
          "id": 2,
          "question": "<p><a name=\"313226\"></a><div itemprop=\"text\"><p>Fill in the missing value</p>\n\n<p><img alt=\"\" src=\"images/gateOverFlowPDFsImages/volume1/general_aptitude_analytical_aptitude_number_relations/b19f56a4acc12629d4a7694d147249aa.png\"></p></div><br><br><b>GATE2015 EC-1: GA-8</b></p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "3",
          "marks": 1,
        ...
        {
          "id": 3,
          "question": "<p><a name=\"313382\"></a><div itemprop=\"text\"><p>Each of the letters in the figure below represents a unique integer from \\( 1 \\) to \\( 9 \\). The letters are positioned in the figure such that each of \\( (A+B+C), (C+D+E), (E+F+G) \\) and \\( (G+H+K) \\) is equal to \\( 13 \\). Which integer does \\( E \\) represent?</p><p><img alt=\"\" src=\"images/gateOverFlowPDFsImages/volume1/general_aptitude_analytical_aptitude_number_relations/a9c1579159491787a0b62ee113c710ac.png\"></p></div><br><br><b>GATE2018 CE-2: GA-10</b></p>",
          "type": "single",
          "options": [
            "<p>\\( 1 \\)</p>",
            "<p>\\( 4 \\)</p>",
