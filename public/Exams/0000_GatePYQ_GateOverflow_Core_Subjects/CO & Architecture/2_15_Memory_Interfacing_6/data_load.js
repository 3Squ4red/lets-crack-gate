  ...
  "sections": [
    {
      ...
      "questions": [
        ...
        {
          "id": 5,
          "question": "<p><a name=\"302846\"></a><div itemprop=\"text\"><p>The chip select logic for a certain DRAM chip in a memory system design is shown below. Assume that the memory system has \\( 16 \\) address lines denoted by \\( A_{15} \\) to \\( A_0 \\). What is the range of address (in hexadecimal) of the memory system that can get enabled by the chip select (CS) signal?</p><p><img alt=\"\" width=\"280\" src=\"images/gateOverFlowPDFsImages/volume2/co_architecture_memory_interfacing/f1604f31498a182d73f4c01ab5008af4.png\"></p></div><br><br><b>GATE CSE 2019 | Question: 2</b></p>",
          "type": "single",
          "options": [
            "<p>C800 to CFFF</p>",
            "<p>CA00 to CAFF</p>",
