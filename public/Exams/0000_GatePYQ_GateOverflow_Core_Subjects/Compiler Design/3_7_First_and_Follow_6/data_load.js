...
{
          "id": 2,
          "question": "<p>For the grammar below, a partial \\( LL(1) \\) parsing table is also presented along with the grammar. Entries that need to be filled are indicated as \\( E1, E2, \\) and \\( E3 \\). \\( \\varepsilon \\) is the empty string, \\( \\$ \\) indicates end of input, and, \\( | \\) separates alternate right hand sides of productions.</p><ul><li> \\( S \\rightarrow aAbB \\mid bAaB \\mid \\varepsilon \\) </li><li> \\( A \\rightarrow S \\) </li><li> \\( B \\rightarrow S \\) </li></ul><p> \\[ \\begin{array}{|c|c|c|c|} \\hline & \\textbf{a} & \\textbf{b} & \\textbf{\\$} \\\\ \\hline S & E1 & E2 & S \\rightarrow \\varepsilon \\\\ \\hline A & A \\rightarrow S & A \\rightarrow S & \\text{error} \\\\ \\hline B & B \\rightarrow S & B \\rightarrow S & E3 \\\\ \\hline \\end{array} \\] </p><p>The FIRST and FOLLOW sets for the non-terminals \\( A \\) and \\( B \\) are</p><br><br><b>GATE CSE 2012 | Question: 52</b>",
          "type": "single",
          "options": [
            "<p>\\( \\text{FIRST}(A) = \\{a, b, \\varepsilon\\} = \\text{FIRST}(B) \\)<br>\\( \\text{FOLLOW}(A) = \\{a, b\\} \\)<br>\\( \\text{FOLLOW}(B) = \\{a, b, \\$\\} \\)</p>",
            "<p>\\( \\text{FIRST}(A) = \\{a, b, \\$\\} \\)<br>\\( \\text{FIRST}(B) = \\{a, b, \\varepsilon\\} \\)<br>\\( \\text{FOLLOW}(A) = \\{a, b\\} \\)<br>\\( \\text{FOLLOW}(B) = \\{\\$\\} \\)</p>",
            "<p>\\( \\text{FIRST}(A) = \\{a, b, \\varepsilon\\} = \\text{FIRST}(B) \\)<br>\\( \\text{FOLLOW}(A) = \\{a, b\\} \\)<br>\\( \\text{FOLLOW}(B) = \\varnothing \\)</p>",
            "<p>\\( \\text{FIRST}(A) = \\{a, b\\} = \\text{FIRST}(B) \\)<br>\\( \\text{FOLLOW}(A) = \\{a, b\\} \\)<br>\\( \\text{FOLLOW}(B) = \\{a, b\\} \\)</p>"
          ],
          "correct_answer": "<p>\\( \\text{FIRST}(A) = \\{a, b, \\varepsilon\\} = \\text{FIRST}(B) \\)<br>\\( \\text{FOLLOW}(A) = \\{a, b\\} \\)<br>\\( \\text{FOLLOW}(B) = \\{a, b, \\$\\} \\)</p>",
          "marks": 1,
          "negative_marks": 0.33,
