  ...
  "sections": [
    {
      ...
      "questions": [
        ...
        {
          "id": 2,
          "question": "<p><a name=\"1051\"></a><div itemprop=\"text\"><p>The routing table of a router &nbsp;is shown below:<br>\n\\[ \\begin{array}{|l|l|l|} \\hline \\textbf {Destination} & \\textbf {Subnet Mask} & \\textbf{Interface}&nbsp; \\\\\\hline \\text {128.75.43.0} & &nbsp;\\text{255.255.255.0} & \\text{Eth0}&nbsp;\\\\\\hline\\text {128.75.43.0} & &nbsp;\\text{255.255.255.128} & \\text{Eth1} \\\\\\hline\\text {192.12.17.5} & &nbsp;\\text{255.255.255.255} & \\text{Eth3}\\\\\\hline \\text {Default} & &nbsp;\\text{} & \\text{Eth2}\\\\\\hline\\end{array} \\]<br>\nOn which interface will the router forward packets addressed to destinations \\( 128.75.43.16 \\) and \\( 192.12.17.10 \\) respectively?</p>\n\n</div><br><br><b>GATE CSE 2004 | Question: 55</b></p>",
          "type": "single",
          "options": [
            "<p>Eth\\( 1 \\) and Eth\\( 2 \\)</p>",
            "<p>Eth\\( 0 \\) and Eth\\( 2 \\)</p>",
        ...
        {
          "id": 9,
          "question": "<p><a name=\"8213\"></a><div itemprop=\"text\"><p>Consider the following routing table at an IP router:<br>\\[ \\begin{array}{|l|l|l|} \\hline \\textbf {Network No} & \\textbf {Net Mask} & \\textbf{Next Hop}&nbsp; \\\\\\hline \\text {128.96.170.0} & &nbsp;\\text{255.255.254.0} & \\text{Interface 0}&nbsp;\\\\\\hline\\text {128.96.168.0} & &nbsp;\\text{255.255.254.0} & \\text{Interface 1} \\\\\\hline\\text {128.96.166.0} & &nbsp;\\text{255.255.254.0} & \\text{R2}\\\\\\hline \\text {128.96.164.0} & &nbsp;\\text{255.255.252.0} & \\text{R3}\\\\\\hline \\text {0.0.0.0} & &nbsp;\\text{Default} & \\text{R4}\\\\\\hline \\end{array} \\]<br>For each IP&nbsp;address in Group I Identify the correct choice of the next hop from Group II using the entries from the routing table above.<br>\\[ \\begin{array}{|ll|ll|} \\hline & \\textbf {Group I} &&nbsp; \\textbf {Group II}&nbsp; \\\\\\hline<br>&\\text{i)&nbsp; &nbsp;128.96.171.92} & &nbsp;\\text{a) Interface 0}&nbsp;\\\\ \\hline<br>&\\text{ii)&nbsp; 128.96.167.151} & &nbsp;\\text{b) Interface 1} \\\\\\hline<br>&\\text{iii) 128.96.163.151} & \\text{c) R2}\\\\ \\hline<br>&\\text{iv) 128.96.164.121} & \\text{d) R3}\\\\&nbsp;\\hline<br>&\\text {} & \\text{e) R4}\\\\\\hline \\end{array} \\]</p></div><br><br><b>GATE CSE 2015 Set 2 | Question: 41</b></p>",
          "type": "single",
          "options": [
