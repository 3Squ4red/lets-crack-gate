  ...
  "sections": [
    {
      ...
      "questions": [
        {
          "id": 1,
          "question": "<p><a name=\"60115\"></a><div itemprop=\"text\"><p>Given two sorted list of size 'm' and 'n' respectively. The number of comparisons needed in the worst case by the&nbsp;merge sort&nbsp;algorithm will be</p></div><br><br><b>UGC NET CSE | December 2013 | Part 2 | Question: 25</b></p>",
          "type": "single",
          "options": [
            "<p>m \\( \\times \\) n</p>",
            "<p>max(m, n)</p>",
