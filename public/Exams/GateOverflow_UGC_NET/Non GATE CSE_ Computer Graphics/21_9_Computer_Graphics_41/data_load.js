  ...
  "sections": [
    {
      ...
      "questions": [
        ...
        {
          "id": 38,
          "question": "<p><a name=\"349607\"></a><div itemprop=\"text\"><p>&nbsp;</p><p>Match \\( \\text{List I} \\) with \\( \\text{List II} \\). \\( \\text{List I} \\)&nbsp;gives \\( 3 \\times 3 \\) matrices representing \\( 2D \\) transformations and \\( \\text{List II} \\) shows the corresponding transformation diagrams.</p><p style=\"text-align:center\"><img alt=\"Matrix table\" width=\"700\" height=\"733\" src=\"images/gateOverFlowPDFsImages/ugcnet/non_gate_cse_computer_graphics_computer_graphics/880cd0a29f36057703a1b31957b55f3f.png\"></p><p>&nbsp;</p><p>Choose the correct answer from the options given below:</p></div><br><br><b>UGC NET CSE | October 2020 | Part 2 | Question: 66</b></p>",
          "type": "single",
          "options": [
