  ...
  "sections": [
    {
      ...
      "questions": [
        ...
        {
          "id": 6,
          "question": "<p><a name=\"59522\"></a><div itemprop=\"text\"><p>The language accepted by the non-deterministic pushdown automaton</p><p>\\( M=( \\{ q_0, q_1, q_2\\}, \\{a, b\\}, \\{ a, b, z\\}, \\delta, q_0, z, \\{q_2\\}) \\) with transitions</p><p>\\( \\delta (q_0 a, z) = \\{ (q_1 a), (q_2 \\lambda) \\} \\);</p><p>\\( \\delta (q_1, b, a) = \\{ (q_1, b) \\} \\)</p><p>\\( \\delta (q_1, b, b) = \\{ (q_1 b) \\}, \\delta (q_1, a, b) = \\{ (q_2, \\lambda ) \\} \\) is</p></div><br><br><b>UGC NET CSE | September 2013 | Part 3 | Question: 19</b></p>",
          "type": "single",
          "options": [
            "<p>\\( L(abb^*a) \\)</p>",
            "<p>\\( \\{a\\} U L(abb^*a) \\)</p>",
