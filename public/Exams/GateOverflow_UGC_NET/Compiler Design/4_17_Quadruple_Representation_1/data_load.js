  ...
  "sections": [
    {
      ...
      "questions": [
        {
          "id": 1,
          "question": "<p><a name=\"316207\"></a><div itemprop=\"text\"><p>On translating the expression given below into quadruple representation, how many operations are required?</p><p>\\[ (i\\ast j)+(e+f)\\ast(a\\ast b+c) \\]</p></div><br><br><b>UGC NET CSE | June 2019 | Part 2 | Question: 72</b></p>",
          "type": "single",
          "options": [
            "<p>\\( 5 \\)</p>",
            "<p>\\( 6 \\)</p>",
