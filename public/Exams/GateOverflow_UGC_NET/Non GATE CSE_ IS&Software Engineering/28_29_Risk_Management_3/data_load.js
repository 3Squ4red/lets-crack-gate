window.__examLoadCallback({
  "title": "Non GATE CSE_ IS&Software Engineering - Risk Management",
  "duration": 8,
  "sections": [
    {
      ...
      "questions": [
        ...
        {
          "id": 2,
          "question": "<p><a name=\"53478\"></a><div itemprop=\"text\"><p>Which one of the following is not a risk management technique for managing the risk due to unrealistic schedules and budgets ?</p></div><br><br><b>UGC NET CSE | June 2014 | Part 2 | Question: 12</b></p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 3,
          "question": "<p><a name=\"59871\"></a><div itemprop=\"text\"><p>Sixty reusable components were available for an application. If only 70% of these components can be used, rest 30% would have to be developed from scratch. If average component is 100 LOC and cost of each LOC is Rs. 14, what will be risk of exposure if risk probability is 80%?</p></div><br><br><b>UGC NET CSE | September 2013 | Part 3 | Question: 50</b></p>",
          "type": "single",
          "options": [
            "<p>Rs. 25, 200</p>",
            "<p>Rs. 20, 160</p>",
