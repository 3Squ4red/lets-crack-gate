  ...
  "sections": [
    {
      ...
      "questions": [
        {
          "id": 1,
          "question": "<p><a name=\"360639\"></a><div itemprop=\"text\"><p>A software program that infers and manipulates existing knowledge in order to generate new knowledge is known as:</p></div><br><br><b>UGC NET CSE | July 2016 | Part 3 | Question: 75</b></p>",
          "type": "single",
          "options": [
            "<p>Data dictionary</p>",
        ...
        {
          "id": 2,
          "question": "<p><a name=\"360640\"></a><div itemprop=\"text\"><p>A perceptron has input weights \\( W_1=-3.9 \\) and \\( W_2=1.1 \\) with threshold value \\( T=0.3. \\)&nbsp;What output does it give for the input \\( x_1=1.3 \\) and \\( x_2=2.2? \\)</p></div><br><br><b>UGC NET CSE | July 2016 | Part 3 | Question: 66</b></p>",
          "type": "single",
          "options": [
            "<p>\\( -2.65 \\)</p>",
            "<p>\\( -2.30 \\)</p>",
