  ...
  "sections": [
    {
      ...
      "questions": [
        ...
        {
          "id": 15,
          "question": "<p>Below is the precedence graph for a set of tasks to be executed on a parallel processing system S.<br><img style=\"max-width:50%;height:auto;border-radius:8px;\" data-lazyloaded=\"1\" decoding=\"async\" src=\"images\\gatePYQ\\CPU_Scheduling\\q10_01cb7317.webp\"><br>  What is the efficiency of this precedence graph on S if each of the tasks \\(T_1, \\dots, T_8\\) takes the same time and the system S has five processors? <br><br><strong>(ISRO CSE 2011)</strong></p>",
          "type": "single",
          "options": [
            "<b>A.</b> <p>25%</p>",
            "<b>B.</b> <p>40%</p>",
