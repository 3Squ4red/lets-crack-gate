window.__examLoadCallback({
  "title": "Discrete Mathematics_ Combinatory - Qod Cse 18",
  "duration": 3,
  "sections": [
    {
      "name": "Qod Cse 18",
      "questions": [
        {
          "id": 1,
          "question": "<p><a name=\"473108\"></a><div itemprop=\"text\"><p>There are three boxes. One box contains ten red socks, another contains ten blue socks, and the third contains a mix five red and five blue socks. The three boxes are labelled R (for red), B (for blue), or M (for mixed), but the labels are permuted so that for EACH drawer the label attached to it does NOT match its contents.</p><p>How many total socks do you have to look at from the drawers, in order to correctly identify each drawer? (You are not allowed to look inside the drawers. You can only pick socks one at a time and observe its colour.)</p></div><br><br><b>TIFR CSE 2025 | Part A | Question: 5</b></p>",
          "type": "single",
          "options": [
            "<p>One sock.</p>",
            "<p>Two socks.</p>",
