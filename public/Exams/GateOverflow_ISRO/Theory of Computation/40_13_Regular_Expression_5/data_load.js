  ...
  "sections": [
    {
      ...
      "questions": [
        ...
        {
          "id": 3,
          "question": "<p><a name=\"435383\"></a><div itemprop=\"text\"><p>Consider the deterministic finite-state automaton (DFA) below. The alphabet is \\( \\{a, b\\} \\). The state with a small incoming arrow is the initial state, while the double circle state denotes a final state.</p><p style=\"text-align:center\"><img alt=\"DFA diagram\" width=\"450\" height=\"365\" src=\"images/gateOverFlowPDFsImages/isro_w_cover/theory_of_computation_regular_expression/d2115dc1f49a87cd5670994b86309994.png\"></p><p>Which of the following regular expressions defines the language accepted by the DFA?</p></div><br><br><b>ISRO CSE 2023 | Question: 13</b></p>",
          "type": "single",
          "options": [
            "<p>\\( a b^{*} \\)</p>",
            "<p>\\( a^{*} b^{*} \\)</p>",
