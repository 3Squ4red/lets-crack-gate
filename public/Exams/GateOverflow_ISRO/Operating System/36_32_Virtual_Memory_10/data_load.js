  ...
  "sections": [
    {
      ...
      "questions": [
        ...
        {
          "id": 6,
          "question": "<p><a name=\"54972\"></a><div itemprop=\"text\"><p>A computer has 16 pages of virtual address space but the size of main memory is only four frames. Initially the memory is empty. A program references the virtual pages in the order 0, 2, 4, 5, 2, 4, 3, 11, 2, 10. How many page faults occur if LRU page replacement algorithm is used?</p></div><br><br><b>ISRO CSE 2014 | Question: 44</b></p>",
          "type": "single",
          "options": [
            "<p>3</p>",
            "<p>5</p>",
        ...
        {
          "id": 7,
          "question": "<p><a name=\"55089\"></a><div itemprop=\"text\"><p>Dirty bit is used to indicate which of the following?</p></div><br><br><b>ISRO CSE 2014 | Question: 70</b></p>",
          "type": "single",
          "options": [
        ...
        {
          "id": 10,
          "question": "<p><a name=\"435338\"></a><div itemprop=\"text\"><p>State whether true or false:</p><ol type=\"i\"><li>Virtualization facilitates multiple OS simultaneously on the same hardware</li><li>In dual boot, multiple OS can run simultaneously</li></ol></div><br><br><b>ISRO CSE 2023 | Question: 57</b></p>",
          "type": "single",
          "options": [
            "<p>(i) True (ii) False</p>",
            "<p>(i) False (ii) True</p>",
