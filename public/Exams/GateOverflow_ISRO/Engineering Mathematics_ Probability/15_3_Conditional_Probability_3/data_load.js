  ...
  "sections": [
    {
      ...
      "questions": [
        ...
        {
          "id": 3,
          "question": "<p><a name=\"45660\"></a><div itemprop=\"text\"><p>Let \\( P(E) \\) denote the probability of the occurrence of event \\( E \\). If \\( P(A)= 0.5 \\) and \\( P(B)=1 \\) then the values of \\( P(A|B) \\) and \\( P(B|A) \\) respectively are</p></div><br><br><b>ISRO-2013-71</b></p>",
          "type": "single",
          "options": [
            "<p>\\( 0.5, 0.25 \\)</p>",
            "<p>\\( 0.25, 0.5 \\)</p>",
